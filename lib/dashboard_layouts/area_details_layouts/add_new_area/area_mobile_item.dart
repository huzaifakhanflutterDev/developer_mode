import 'package:developer_mode/dashboard_layouts/area_details_layouts/edit_screen_layout/edit_area_layout.dart';
...
class AreaMobileItem extends StatelessWidget {
  const AreaMobileItem({Key? key}) : super(key: key);
