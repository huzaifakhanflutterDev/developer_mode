...
class NewAreaTabItem extends StatelessWidget {
  LatLng initial;
  double he, w;
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: [
          Padding(
            padding: EdgeInsets.symmetric(horizontal: context.width * .5.sp),
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: he * .7.sp),
                MyText(
                  text: "Select Payment method",
                  weight: FontWeight.w500,
                  color: Color(0xff191A1E).withOpacity(0.5),
                  textScale: 4.75.sp,
                ).paddingOnly(bottom: he * .75.sp),
                ListView.separated(
                  itemCount: 3,
                ...
                PopupMenuButton(
                  ...
                  itemBuilder: (context) => [
                    PopupMenuItem(
                      child: MyText(text: "Toronto",textScale: 5.sp,weight: FontWeight.w400,),
                      value: "Toronto",
                    ),
                    PopupMenuItem(
                      child: MyText(text: "Toronto",textScale: 5.sp,weight: FontWeight.w400,),
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      title: MyText(text: "Toronto",textScale: 5.sp,weight: FontWeight.w400,),
