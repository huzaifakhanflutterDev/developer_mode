import 'package:developer_mode/dashboard_layouts/users_layouts/service_seekers/completed_services/completed_tabs.dart';
...
class CompletedServiceLayout extends StatelessWidget {
  Map<String, dynamic> data;
  String type;

  CompletedServiceLayout({required this.data, required this.type});
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: Center(
            child: MyText(
              text: type == "Service Providers" ? "Available" : "Completed",
