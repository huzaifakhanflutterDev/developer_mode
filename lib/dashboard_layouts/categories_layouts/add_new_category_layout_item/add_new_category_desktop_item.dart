...
import '../add_options/add_options_layout.dart';

class AddNewCategoryDesktopItem extends StatelessWidget {
  MyTextFieldController controller;
  String name, option, title;

  AddNewCategoryDesktopItem({
    required this.title,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              width: context.width * 1.91.sp,
              // height: context.height * .75.sp,
              child: MyTextField(hint: "UIUX"),
            ),
            MyText(
              ...
              child: Obx(() {
                return ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    }).paddingSymmetric(vertical: context.height * .2.sp);
                  },
                );
              }),
            ),
